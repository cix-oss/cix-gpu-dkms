...
struct kbase_pm_core_masks kbase_pm_ca_get_core_masks(struct kbase_device *kbdev)
{
	...
	cur_core_masks.pm_core_mask_debug &= kbdev->harvesting_core_mask;
	cur_core_masks.pm_core_mask_devfreq &= kbdev->harvesting_core_mask;
	cur_core_masks.pm_core_mask_desired &= kbdev->harvesting_core_mask;
	cur_core_masks.pm_core_mask_alloc_en &= kbdev->harvesting_core_mask;
#endif
